...
def train(args):
    ...
    if finetune=='True':
        #model_path='/home/cdd/code2/dcase2020_task1/workspace/checkpoints/main/logmel_86frames_40melbins/TAU-urban-acoustic-scenes-2020-mobile-development/holdout_fold=1/Logmel_Wavegram_Logmel_Cnn14/2000_iterations.pth'
